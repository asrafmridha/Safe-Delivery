...
<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1 class="m-0 text-dark">Generate Delivery Rider Run Edit </h1>
        </div>
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('branch.home') }}">Home</a></li>
            <li class="breadcrumb-item active">Generate Delivery Rider Run Edit </li>
        </ol>
        </div>
    </div>
    </div>
  ...
  <div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form role="form" action="{{ route('branch.parcel.confirmDeliveryRiderRunGenerateEdit', $riderRun->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return createForm()">
                    @csrf
                    @method('PATCH')
    ...
    window.onload = function(){
        ...
        $('#addParcelInvoice').on('click', function(){
            ...
            $.ajax({
                ...
                url       : "{{ route('branch.parcel.deliveryRiderEditRunParcelAddCart') }}",
