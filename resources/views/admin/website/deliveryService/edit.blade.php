                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Edit Delivery Services </h3>
                        ...
                        <div class="card-body">
                            <div class="col-md-offset-1 col-md-10 ">
                                <div class="card card-primary">
                                    <form role="form" action="{{ route('admin.deliveryService.update', $deliveryService->id) }}" method="POST"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="name" value="{{ $deliveryService->name ?? old('name') }}" class="form-control" placeholder="Service Name" >
                                            </div>
                                            <div class="form-group">
                                                <label for="short_details">Short Details</label>
                                                <textarea type="text" name="short_details" id="short_details" class="form-control" placeholder="Delivery Service Short Details" >{{ $deliveryService->short_details ?? old('short_details') }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="long_details">Long Details</label>
                                                <textarea type="text" name="long_details" id="long_details" class="form-control textarea" placeholder="Delivery Service Long Details" >{{ $deliveryService->long_details ??  old('long_details') }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div id="preview_file_image" style="margin-top: 10px;">
                                                    @if ($deliveryService->image != null)
                                                        <img src="{{ asset('uploads/deliveryService/' . $deliveryService->image) }}"
                                                            class="img-fluid img-thumbnail" style="height: 100px" alt="Delivery Service Image">
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="preview_file_icon" style="margin-top: 10px;">
                                                    @if ($deliveryService->icon != null)
                                                        <img src="{{ asset('uploads/deliveryService/' . $deliveryService->icon) }}"
                                                             class="img-fluid img-thumbnail" style="height: 100px" alt="Delivery Service Icon">
                                                    @endif
                                                </div>
                                                @if ($deliveryService->icon != null)
...
<script src="{{ asset('plugins/summernote/summernote-bs4.min.js') }}"></script>
    <script>
        $(function () {
            $('.textarea').summernote({
                placeholder: 'Enter Service Long Details',
                height: 250
            })
        })
