                    ...
                    <legend>Parcel Payment Request Information</legend>
                        <table class="table table-style">
                            <tr>
                                ...
                                <td style="width: 50%"> {{ $parcelPaymentRequest->payment_request_invoice }} </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 50%">
                                    @switch($parcelPaymentRequest->status)
                                        ...
                                        <span class='text-bold text-danger' style='font-size:16px;'>Rejected</span>
                                            @break
                                        @case(4)
                                        <span class='text-bold text-primary' style='font-size:16px;'>Processing</span>
                                            @break
                                        @case(5)
                                        <span class='text-bold text-danger' style='font-size:16px;'>Paid</span>
                                            @break
                                        @default
