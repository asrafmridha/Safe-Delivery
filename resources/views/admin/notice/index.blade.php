...
@section('content')
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Notice and News List</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
            <li class="breadcrumb-item active">Notice and News List</li>
          </ol>
        </div>
      </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"> Notice and News List </h3>
                        <a href="{{ route('admin.notice.create') }}" class="btn btn-success float-right">
                            <i class="fa fa-pencil-alt"></i> Add New Notice Or News
                        </a>
                    </div>
                    <div class="card-body">
                        <table id="yajraDatatable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th width="10%" class="text-center"> NoticeOrNews For </th>
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header bg-primary">
                      <h4 class="modal-title">View Notice Or News Details</h4>
  ...
  <script>
    window.onload = function(){
        ...
        var table = $('#yajraDatatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('admin.notice.getNoticeList') !!}',
            columns: [
                { data: 'DT_RowIndex', orderable: false , searchable: false},
                { data: 'title', name: 'title' , class : "text-center"},
                { data: 'type', name: 'type' , class : "text-center"},
                { data: 'publish_for', name: 'publish_for' , class : "text-center"},
        ...
        $('#yajraDatatable').on('click', '.view-modal', function(){
            ...
            var url = "{{ route('admin.notice.show', ":notice_id") }}";
            url = url.replace(':notice_id', notice_id);
            $('#showResult').html('');
        ...
        $('#yajraDatatable').on('click', '.updateStatus', function(){
            ...
            var notice_id       = status_object.attr('notice_id');
            var status          = status_object.attr('status');
            var url             = "{{ route('admin.notice.updateStatus') }}";
        ...
        $('#yajraDatatable').on('click', '.delete-btn', function(){
            ...
            var sttaus = confirm("Are you sure delete this notice?");
