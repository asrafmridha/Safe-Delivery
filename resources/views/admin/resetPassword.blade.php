    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <br>
                <p class="login-box-msg text-success" style="font-size: 22px; font-weight: bold">Confirm Admin Rest Password </p>
                ...
                @if($checkTime <= 60 && $verification == 0)
                    <form action="{{ route('admin.resetPassword') }}" method="post">
                        ...
                        <div class="input-group mb-3">
                            <input type="email" name="email" class="form-control" placeholder="Email Address" value="{{ $admin->email }}" readonly >
