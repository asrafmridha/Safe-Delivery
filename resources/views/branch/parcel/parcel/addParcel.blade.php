            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <form role="form" action="{{ route('branch.parcel.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return createForm()">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                    ...
                                                    <fieldset >
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                             ...
                                                             <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="total_collect_amount">Total Collection Amount(COD)<code>*</code></label>
                                                                    <input type="number" name="total_collect_amount" id="total_collect_amount" value="{{ old('total_collect_amount') }}" class="form-control" placeholder="0.00" required >
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6 col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="district_id" id="district_id" class="form-control select2" style="width: 100%" disabled>
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset >
                                                        ...
                                                        <div class="row">
                                                           ...
                                                           <!--       <input type="text" id="weight_package_id" name="weight_package_id" value="2" class="form-control" placeholder="Search or select a weight package" disabled>-->
                                                           <!--   </div>-->
                                                           <!--</div>-->
                                                ...
                                                <div class="col-md-12 text-center">
                                                    <input type="hidden" name="select_pickup_address" id="select_pickup_address" value="1">
                                                    <input type="hidden" name="delivery_option_id" id="delivery_option_id" value="1">
                                                    <input type="hidden" name="pickup_address" id="pickup_address" value="">

                                                    <button type="submit" class="btn btn-success" id="generateBtn">Submit</button>
                                                        ...
                                                        <table class="table ">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <span id="view_cod_percent">
                                                                    ...
                                                                    <input type="hidden" id="confirm_cod_percent" name="cod_percent" value="0">
                                                                    <input type="hidden" id="confirm_merchant_cod_percent"   value="0">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td style="width: 50%">
                                                                    ...
                                                                    <input type="number" id="view_weight_package_charge" name="view_weight_package_charge" value="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 10%"> : </td>
                                                                <td style="width: 50%">
                                                                    <span id="view_delivery_charge" style="display:none">0.00</span>
                                                                    <input type="number" id="confirm_delivery_charge" name="delivery_charge" value="0">
                                                                    <input type="hidden" id="confirm_merchant_service_area_charge" name="merchant_service_area_charge" value="0">
                                                                    <input type="hidden" id="confirm_merchant_service_area_return_charge" name="merchant_service_area_return_charge" value="0">
                                                                    <input type="hidden"
                    ...
                    $.ajax({
                        ...
                        success   : function(response){
                            if(response.success){
                                ...
                                $("#shop_id").html(response.merchant_shop_option).val(0).attr('disabled', false);

                                html += "<tr>\n" +
                                    "<th style=\"width: 40%\">Merchant Company </th>\n" +
                                    "<td style=\"width: 10%\"> : </td>\n" +
                                    "<td style=\"width: 50%\"> " +
                                    "<input type=\"hidden\" id=\"merchant_full_address\" value=\" "+response.merchant_data.address+"\">" +
                                    "<input type=\"hidden\" id=\"merchant_business_address\" value=\""+response.merchant_data.business_address+"\">" +
                                    ""+response.merchant_data.company_name+" </td>\n" +
                                    "</tr>\n" +
                                    "<tr>\n" +
                                    "<th style=\"width: 40%\">Merchant Name</th>\n" +
                                    "<td style=\"width: 10%\"> : </td>\n" +
                                    "<td style=\"width: 50%\"> "+response.merchant_data.name+" </td>\n" +
                                    "</tr>\n" +
                                    "<tr>\n" +
                                    "<th style=\"width: 40%\">Merchant Contact </th>\n" +
                                    "<td style=\"width: 10%\"> : </td>\n" +
                                    "<td style=\"width: 50%\"> "+response.merchant_data.contact_number+" </td>\n" +
                                    "</tr>";
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.success) {
                                ...
                                // Delivery Charge Comes from Service Area default_charge Or Merchant Set Service Charge
                                $("#confirm_delivery_charge").val(returnNumber(response.charge).toFixed(2));
...
//            }
            ...
            // If all validations pass, disable the button
