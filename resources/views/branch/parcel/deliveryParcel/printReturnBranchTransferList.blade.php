...
<head>
    ...
    <title>Return Branch Transfer List</title>
    <style>
        table, td, th {
...
<div>
    <div class="center">
        ...
        <h4 class="text-center">Return Branch Transfer List</h4>
    ...
    <table>
        ...
        @foreach($returnBranchTransfers as $key => $returnBranchTransfer)
            ...
            <tr>
                ...
                <td class="text-center">{{$returnBranchTransfer->to_branch->name}}</td>
                <td class="text-center">{{$returnBranchTransfer->to_branch->address}}</td>
                <td class="text-center">{{$returnBranchTransfer->to_branch->contact_number}}</td>
