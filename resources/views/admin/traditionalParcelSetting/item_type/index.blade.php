                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('admin.item.type.create') }}" class="btn btn-success float-right">
    ...
    <script>
        window.onload = function() {
            ...
            var table = $('#yajraDatatable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.item.type.datatable') }}",
                columns: [
            ...
            $('#yajraDatatable').on('click', '.updateStatus', function() {
                ...
                var url = "{{ route('admin.item.type.update.status') }}";
            ...
            $('#yajraDatatable').on('click', '.delete-btn', function() {
                var status_object = $(this);
                var data_id = status_object.attr('data_id');
                var url = "{{ route('admin.item.type.delete') }}";
            ...
            $(document).on('click', '#printBtn', function(){
                $.ajax({
                    type: 'GET',
                    url: '{!! route('admin.item.type.print') !!}',
                    data: {},
                    dataType: 'html',
