    ...
    <span id="type_receive" style="display:block;">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form role="form" id="myReceiveForm" action="{{ route('admin.operationBookingParcel.confirmWarehouseReceived') }}" method="POST" enctype="multipart/form-data" onsubmit="return receive_submit_data()">
                            @csrf
                                        ...
                                        <div class="col-md-5">
                                            <table class="table ">
                                                <tr>
                                                    ...
                                                    <td style="width: 5%"> : </td>
                                                    <td>
                                                        <select name="receive_warehouse_id" id="receive_warehouse_id" onchange="booking_parcel_list_receive()" class="form-control select2" style="width: 100%" >
                                                        ...
                                                        <input type="hidden" name="receive_warehouse_type" id="receive_warehouse_type" value="">
                                                    </td>
                                                </tr>
    ...
    <span id="type_assign" style="display:none;">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form role="form" id="myAssignForm" action="{{ route('admin.operationBookingParcel.confirmAssignVehicleOrWarehouse') }}" method="POST" enctype="multipart/form-data" onsubmit="return assign_submit_data()">
                            @csrf
                                        ...
                                        <div class="col-md-5">
                                            <table class="table ">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 5%"> : </td>
                                                    <td>
                                                        <select name="from_warehouse_id" id="from_warehouse_id" onchange="booking_parcel_list_assign('no')" class="form-control select2" style="width: 100%" >
                                                            <option value="0" >Select Warehouse </option>
                                                            <?php
                                                            if(count($warehouses) > 0) {
                                                                foreach ($warehouses as $warehouse) {
                                                        ...
                                                        <input type="hidden" name="from_warehouse_type" id="from_warehouse_type" value="">
                                                    </td>
                                                </tr>
...
@push('script_js')
    ...
    <script>
        ...
        window.onload = function(){
            ...
            $(document).on("click", ".rejectParcel", function () {
                ...
                $.ajax({
                    ...
                    url       : "{{ route('admin.operationBookingParcel.rejectParcelFromWarehouse') }}",
        ...
        function booking_parcel_list_receive(){
            ...
            var warehouse  = $("#receive_warehouse_id option:selected");
            var warehouse_id  = warehouse.val();
            if(warehouse_id == 0){
                toastr.error("Please Select Warehouse");
                $("#show_booking_parcel_list_for_receive").html('');
                $("#receive_warehouse_type").val("");
                return false;
            }else{
                $("#receive_warehouse_type").val(warehouse.data('type'));
            }
            ...
            $.ajax({
                ...
                url       : "{{ route('admin.operationBookingParcel.getParcelListForVehicleToWarehouseReceive') }}",
                error     : function(xhr){ alert("An error occurred: " + xhr.status + " " + xhr.statusText); },
                success   : function(response){
        ...
        function booking_parcel_list_assign(value){
            ...
            var warehouse  = $("#from_warehouse_id option:selected");
            var warehouse_id  = warehouse.val();
            ...
            if(value == 'yes') {
                if(warehouse_id == 0){
                    ...
                    $("#from_warehouse_type").val('');
                    return false;
                }else{
                    $("#from_warehouse_type").val(warehouse.data('type'));
                }
            ...
            $.ajax({
                ...
                url       : "{{ route('admin.operationBookingParcel.getParcelListForWarehouseToVehicleWarehouseAssign') }}",
                error     : function(xhr){ alert("An error occurred: " + xhr.status + " " + xhr.statusText); },
                success   : function(response){
        ...
        function receive_submit_data() {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.operationBookingParcel.confirmWarehouseReceived') }}",
                type: "POST",
                dataType: "json",
                ...
                success: function(data) {
                    if (data.success == true) {
                        ...
                        window.location = "{{ route('admin.operationBookingParcel.bookingParcelOperation') }}";
                        //$('#preview_file').html('');
        ...
        function assign_submit_data() {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.operationBookingParcel.confirmAssignVehicleOrWarehouse') }}",
                type: "POST",
                dataType: "json",
