<div class="modal-header bg-default">
    <h4 class="modal-title">Delivery Rider Assign </h4>
    <button type="button" class="close bg-danger" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>
<div class="modal-body">
    <form role="form" action="{{ route('branch.parcel.confirmAssignDeliveryRider') }}" id="confirmAssignPickupRider" method="POST" enctype="multipart/form-data" onsubmit="return createForm(this)">
                    ...
                    <div class="col-md-12">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <select name="delivery_rider_id" id="delivery_rider_id" class="form-control select2" style="width: 100%" onchange="return returnBranchResult()">
                            ...
                            <table class="table table-style">
                                <tr>
                                    ...
                                    <td style="width: 10%"> : </td>
                                    <td style="width: 50%">
                                        <span id="view_delivery_rider_name">Not Confirm </span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 10%"> : </td>
                                    <td style="width: 50%">
                                        <span id="view_delivery_rider_contact_number">Not Confirm </span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 10%"> : </td>
                                    <td style="width: 50%">
                                        <span id="view_delivery_rider_address">Not Confirm </span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 10%"> : </td>
                                    <td style="width: 50%">
                                        <span id="view_delivery_rider_district">Not Confirm </span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 10%"> : </td>
                                    <td style="width: 50%">
                                        <span id="view_delivery_rider_upazila">Not Confirm </span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 10%"> : </td>
                                    <td style="width: 50%">
                                        <span id="view_delivery_rider_area">Not Confirm </span>
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
...
<script>
    ...
    function returnBranchResult(){
        var rider_id   = $("#delivery_rider_id option:selected").val();
        $.ajax({
            cache     : false,
            type      : "POST",
            dataType  : "JSON",
            ...
            success   : function(response){
                if(response.success){
                    $("#view_delivery_rider_name").html(response.rider.name);
                    $("#view_delivery_rider_contact_number").html(response.rider.contact_number);
                    $("#view_delivery_rider_address").html(response.rider.address);
                    $("#view_delivery_rider_district").html(response.rider.district.name);
                    $("#view_delivery_rider_upazila").html(response.rider.upazila.name);
                    $("#view_delivery_rider_area").html(response.rider.area.name);
                }
                else{
                    $("#view_delivery_rider_name").html("Not Confirm ");
                    $("#view_delivery_rider_contact_number").html("Not Confirm ");
                    $("#view_delivery_rider_address").html("Not Confirm ");
                    $("#view_delivery_rider_district").html("Not Confirm ");
                    $("#view_delivery_rider_upazila").html("Not Confirm ");
                    $("#view_delivery_rider_area").html("Not Confirm ");
                }
            }
        })
    }
    ...
    function createForm(object){
        ...
        let rider_id = $('#delivery_rider_id').val();
        if(rider_id == '0'){
