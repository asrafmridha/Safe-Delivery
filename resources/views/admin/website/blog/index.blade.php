  ...
  <script>
    window.onload = function(){
        ...
        var table = $('#yajraDatatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('admin.blog.getBlogs') !!}',
            columns: [
        ...
        $('#yajraDatatable').on('click', '.view-modal', function(){
            ...
            var url = "{{ route('admin.blog.show', ":blog_id") }}";
        ...
        $('#yajraDatatable').on('click', '.updateStatus', function(){
            ...
            var blog_id  = status_object.attr('blog_id');
            var status    = status_object.attr('status');
            var url       = "{{ route('admin.blog.updateStatus') }}";
        ...
        $('#yajraDatatable').on('click', '.delete-btn', function(){
            var status_object = $(this);
            var blog_id   = status_object.attr('blog_id');
            var url         = "{{ route('admin.blog.delete') }}";

            var sttaus = confirm("Are you sure delete this blog?");
