...
<div class="modal-body">
    <form role="form" action="{{ route('branch.parcel.confirmReturnRiderRunReconciliation', $riderRun->id) }}" id="confirmAssignDeliveryBranch" method="POST" enctype="multipart/form-data" onsubmit="return createForm(this)">
                            ...
                            <table class="table table-style">
                                ...
                                <tr>
                                    ...
                                    @switch($riderRun->status)
                                        @case(1) <div class="badge badge-success">Run Create </div>  @break
                                        @case(2) <div class="badge badge-success">Run Start </div>  @break
                                        @case(3) <div class="badge badge-danger " >Run Cancel </div>  @break
                                        @case(4) <div class="badge badge-success">Run Complete </div> @break
                                        @default
                                    @endswitch
                                    </td>
                                </tr>
...
<div class="modal-footer">
    <button  type="button" class="btn btn-danger float-right" id="viewModalCloseBtn" data-dismiss="modal">Close</button>
</div>
