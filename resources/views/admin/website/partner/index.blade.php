            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.partner.create') }}" class="btn btn-success float-right">
                            <i class="fa fa-pencil-alt"></i> Add Partner
                        </a>
                    </div>
                    <div class="card-body">
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header bg-primary">
                      <h4 class="modal-title">View Partner </h4>
  ...
  <script>
    window.onload = function(){
        ...
        var table = $('#yajraDatatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('admin.partner.getPartners') !!}',
            columns: [
        ...
        $('#yajraDatatable').on('click', '.view-modal', function(){
            ...
            var url = "{{ route('admin.partner.show', ":partner_id") }}";
            url = url.replace(':partner_id', partner_id);
            $('#showResult').html('');
        ...
        $('#yajraDatatable').on('click', '.updateStatus', function(){
            ...
            var partner_id  = status_object.attr('partner_id');
            var status    = status_object.attr('status');
            var url       = "{{ route('admin.partner.updateStatus') }}";
        ...
        $('#yajraDatatable').on('click', '.delete-btn', function(){
            ...
            var sttaus = confirm("Are you sure delete this partner?");
