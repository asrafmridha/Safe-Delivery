                                        ...
                                        @if($riderRun->rider_run_details->count() > 0)
                                            @foreach($riderRun->rider_run_details as $rider_run_detail)
                                                <tr style="background-color: #f4f4f4;">
                                                    ...
                                                    <td class="text-center" >
                                                        {{ $rider_run_detail->parcel->merchant->company_name }}
                                                    </td>
                                                    <td class="text-center" >
                                                    ...
                                                    <td class="text-center" >
                                                        <a href="{{ route('parcel.printParcel', $rider_run_detail->parcel->id) }}" class="btn btn-success btn-sm" title="Print Parcel" target="_blank">
