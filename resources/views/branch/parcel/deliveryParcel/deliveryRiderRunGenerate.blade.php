    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <form role="form" action="{{ route('branch.parcel.confirmDeliveryRiderRunGenerate') }}" method="POST" enctype="multipart/form-data" onsubmit="return createForm()">
                    @csrf
                    ...
                    <div class="col-md-12 row" style="margin-top: 20px;">
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" name="parcel_invoice" id="parcel_invoice" class="form-control" placeholder="Enter Parcel Invoice Barcode" style="font-size: 20px; box-shadow: 0 0 5px rgb(62, 196, 118);
                                    padding: 3px 0px 3px 3px;
                                    margin: 5px 1px 3px 0px;
                                    border: 1px solid rgb(62, 196, 118);">
                            </div>
                            ...
                            @if($parcels->count() > 0)
                                @foreach($parcels as $parcel)
                                    ...
                                    <tr style="background-color: #f4f4f4;">
                                        ...
                                        @php
                                          $date = ((date("Y-m-d H:i:s") >= date("Y-m-d H:i:s", strtotime("+72 hours", strtotime($parcel->created_at))))&&($parcel->status<25));
                                        @endphp


                                        @if($date)
                                            <td class="text-center" style="    background: #e55555;
