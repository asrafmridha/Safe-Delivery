...
@section('main')
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Transaction create</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <fieldset class="scheduler-border">
        <legend class="scheduler-border">Create Transaction</legend>
        <form action="{{route('transaction.create')}}" method="post" id="createForm" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="number" name="b_rate" class="form-control @error('b_rate') is-invalid @enderror"
                           id="b_rate" value="{{old('b_rate')??0}}" step="any"
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="number" name="s_rate" class="form-control @error('s_rate') is-invalid @enderror"
                           id="rate" value="{{old('s_rate')??0}}" step="any"
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" name="beneficiary" class="form-control @error('beneficiary') is-invalid @enderror"
                           id="beneficiary" value="{{old('beneficiary')}}"
          ...
          {{--  <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="supplier_representative" class="form-control @error('supplier_representative') is-invalid @enderror"
          ...
          {{--  <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="client_representative" class="form-control @error('client_representative') is-invalid @enderror"
            ...
            <div class="row select2-dropdownParent" id="mainForm">
...
@section('script')
    <script>
        $(document).ready(function () {
            ...
            $(".transaction_checkbox").change(function () {
                if ($("#clientTransaction").is(":checked")) {
                    var url = "{{ route('transaction.create.form', 'client') }}";
                    $.ajax({
                        cache: false,
                        type: "GET",
                        url: url,
                ...
                } else if ($("#paymentTransaction").is(":checked")) {
                    var url = "{{ route('transaction.create.form', 'payment') }}";
                    $.ajax({
                        cache: false,
                        type: "GET",
                        url: url,
        ...
        window.onload = function () {
            ...
            $('#createForm').on('click', '.status-modal', function () {
