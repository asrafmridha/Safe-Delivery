...
@section('content')
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Thana/Upazilas</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
            <li class="breadcrumb-item active">Thana/Upazilas</li>
          </ol>
        </div>
      </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"> Thana/Upazilas List </h3>
                        <a href="{{ route('admin.upazila.create') }}" class="btn btn-success float-right">
                            <i class="fa fa-pencil-alt"></i> Add Thana/Upazila
                        </a>
                    </div>
                    <div class="card-body">
                        <table id="yajraDatatable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th width="30%" class="text-center"> District </th>
  ...
  <script>
    window.onload = function(){
        ...
        var table = $('#yajraDatatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('admin.upazila.getUpazilas') !!}',
            columns: [
        ...
        $('#yajraDatatable').on('click', '.updateStatus', function(){
            ...
            var upazila_id  = status_object.attr('upazila_id');
            var status          = status_object.attr('status');
            var url             = "{{ route('admin.upazila.updateStatus') }}";
        ...
        $('#yajraDatatable').on('click', '.delete-btn', function(){
            var status_object = $(this);
            var upazila_id   = status_object.attr('upazila_id');
            var url         = "{{ route('admin.upazila.delete') }}";

            var sttaus = confirm("Are you sure delete this upazila?");
