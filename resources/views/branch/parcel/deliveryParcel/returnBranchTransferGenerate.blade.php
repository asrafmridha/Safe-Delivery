...
<div class="content-header">
  ...
  <div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form role="form" action="{{ route('branch.parcel.confirmReturnBranchTransferGenerate') }}" method="POST" enctype="multipart/form-data" onsubmit="return createForm()">
                    @csrf
                        ...
                        <div class="col-md-12">
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <fieldset id="div_return_branch_transfer_parcel" style="display: none">
