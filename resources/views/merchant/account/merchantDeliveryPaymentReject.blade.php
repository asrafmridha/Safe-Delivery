<div class="modal-header bg-default">
    <h4 class="modal-title">Merchant Delivery Payment Reject</h4>
    <button type="button" class="close bg-danger" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>
<div class="modal-body">
    <form role="form" action="{{ route('merchant.account.merchantDeliveryPaymentRejectConfirm', $parcelMerchantDeliveryPayment->id) }}" id="confirmAssignDeliveryBranch" method="POST" enctype="multipart/form-data" onsubmit="return createForm(this)">
        @method('patch')
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <table class="table table-style">
                                ...
                                <tr>
                                    <th colspan="3">
                                        <textarea name="note" class="form-control" placeholder="Merchant Delivery Payment Reject Note">{{ $parcelMerchantDeliveryPayment->note }}</textarea>
                                    </th>
                                </tr>
                            </table>
                            </div>
                            ...
                            <table class="table table-style table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"> {{ $parcel_merchant_delivery_payment_detail->parcel->merchant->name }} </td>
