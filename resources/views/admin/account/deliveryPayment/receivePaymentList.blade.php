...
@section('content')
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Branch Delivery Receive Payment List</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
            <li class="breadcrumb-item active">Branch Delivery Receive Payments List</li>
          </ol>
        </div>
      </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Branch Delivery Receive Payment List </h3>
    ...
    window.onload = function(){
        ...
        function load_data(branch_id = '', status = '', from_date = '', to_date = ''){
            var table = $('#yajraDatatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url:'{!! route('admin.account.getBranchDeliveryReceivePaymentList') !!}',
                    data:{
                        branch_id   : branch_id,
                        status      : status,
                        from_date   : from_date,
