                        ...
                        <div class="card-body">
                            <div class="offset-md-1 col-md-10 ">
                                <div class="card card-primary">
                                    <form role="form" action="{{ route('branch.parcel.merchantBulkParcelImport') }}"
                                        ...
                                        <div class="card-body row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="rider_id" id="rider_id" class="form-control select2"
                                                        ...
                                                        @foreach ($riders as $rider)
                                                                <option value="{{ $rider->id }}" riderContactNumber="{{ $rider->contact_number }}" riderAddress="{{ $rider->address }}">
                                                                    {{ $rider->name }} </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <table class="table ">
                                                    <tr>
                                                        <td colspan="3">
                                                            <a href="{{ asset('format/Branch-Merchant-Bulk-Parcel-Format.xlsx') }}"
