<div class="modal-header bg-default">
    <h4 class="modal-title">Parcel Pickup Reschedule</h4>
    <button type="button" class="close bg-danger" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>
<div class="modal-body">
    <form role="form" action="{{ route('rider.parcel.confirmParcelPickupReschedule') }}" id="confirmParcelPickupComplete" method="POST" enctype="multipart/form-data" onsubmit="return createForm(this)">
