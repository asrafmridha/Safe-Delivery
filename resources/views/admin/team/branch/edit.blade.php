                                    ...
                                    <form role="form" action="{{ route('admin.branch.update', $branch->id) }}" method="POST"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="name" value="{{ $branch->name ?? old('name') }}" class="form-control" placeholder="Branch Name" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="address">Full Address</label>
                                                <input type="text" name="address" id="address" value="{{ $branch->address ?? old('address') }}" class="form-control" placeholder="Branch Address" required>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" name="contact_number" id="contact_number" value="{{ $branch->contact_number ??  old('contact_number') }}" class="form-control"  placeholder="Branch Contact Number" required="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="email">Email</label>
                                                <input type="email" name="email" id="email" value="{{ $branch->email ??  old('email') }}" class="form-control" placeholder="Email" required>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div id="preview_file_image" style="margin-top: 10px;">
                                                    @if ($branch->image != null)
                                                        <img src="{{ asset('uploads/branch/' . $branch->image) }}"
...
<script>
    $("#district_id").val('{{ $branch->district_id }}');
    $("#upazila_id").val('{{ $branch->upazila_id }}');
    $("#area_id").val('{{ $branch->area_id }}');
