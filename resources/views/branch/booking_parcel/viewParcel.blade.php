                    ...
                    <fieldset>
                        ...
                        <table class="table table-style">
                            ...
                            <tr>
                                ...
                                <td style="width: 10%"> : </td>
                                <td style="width: 50%" class="text-right"> {{ number_format($booking_parcel->collection_amount,2) }} </td>
                            </tr>
                            @if ($booking_parcel->status == 8)
                                <tr>
                                    <th style="width: 40%">Customer Due Collection Amount </th>
                                    <td style="width: 10%"> : </td>
                                    <td style="width: 50%" class="text-right"> {{ number_format($booking_parcel->customer_due_amount,2) }} </td>
                                </tr>
                                <tr>
                                    <th style="width: 40%">Customer Collection Amount </th>
                                    <td style="width: 10%"> : </td>
                                    <td style="width: 50%" class="text-right"> {{ number_format($booking_parcel->customer_collected_amount,2) }} </td>
                                </tr>
                            @endif
                        </table>
                    </fieldset>
