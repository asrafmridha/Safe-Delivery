...
<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1 class="m-0 text-dark">Edit Return Parcel</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('branch.home') }}">Home</a></li>
                <li class="breadcrumb-item active">Edit Return Parcel</li>
            </ol>
        </div>
    </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Edit Return Parcel </h3>
                    ...
                    <div class="card-body">
                        <div class="col-md-12">
                            <form role="form" action="{{ route('branch.parcel.confirmEditReturnParcel', $parcel->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return createForm()">
                                @method('patch')
                                @csrf
                                <div class="card-body">
                                    <div class="row">
