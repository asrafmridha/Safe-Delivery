...
@section('main')
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('country')}}"
                                                           class="breadcrumb-link">Countries</a>
                            </li>
    ...
    <fieldset class="scheduler-border">
        <legend class="scheduler-border">Edit Country</legend>
        <form action="{{route('country.edit',$data->id)}}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-6">
