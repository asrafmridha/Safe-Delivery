...
@media (max-width: 767px) {
    ...
    @if($deliveryServices->count() > 0)
        <section class="end-to-end mt-5 ">
             <div class="container">
                 
                 
           <h2 class=" text-center h4 font-weight-bold">First to Last mile Delivery Solutions for Every Types of
    Merchants</h2>
    
<div class="text-center">
    <a href="merchant-registration" class="btn btn-danger px-3 btn-header1" style="
    margin-top: 30px;
    padding: 10px;
    background: red;
    font-size: 20px;
...
">
	...
	<!-- services start -->
	<div id="service-detail" class="services-main-block-2">
		<div class="container">
...
<h4 class="services-heading"><a href="{{ route('frontend.serviceDetails', $service->slug) }}" title="{{ $service->name }}">{{ \Illuminate\Support\Str::limit($service->name, 20) }}</a></h4>
                            <p>{{ \Illuminate\Support\Str::limit($service->short_details, 60) }}</p>
...
<!--    @endif-->
    ...
    {{-- 
        ...
        <div style="background: #30A3D9; padding-bottom: 38px; padding-top: 39px;">
...
<div style="background: #000000; padding-bottom: 38px; padding-top: 39px;">
...
@push('style_css')
    <style>
        .calculate-charge-section {
            position: relative;
            padding: 55px 0;
            background: -moz-linear-gradient(-45deg, color1 0%, color1 100%);
        ...
        .calculate-charge-section {
            ...
            background: linear-gradient(135deg, #30A3D9 0%, #ea1b22  100%);
            filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#8400fc', endColorstr='#11def4', GradientType=1);
        }
