                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center" >
                                                <a href="{{ route('parcel.printParcel', $rider_run_detail->parcel_id) }}" class="btn btn-success btn-sm" title="Print Parcel" target="_blank">
                                            ...
                                            <select name="status[]"  class="form-control select2 rider_run_status" style="width: 100%" onchange="return rider_run_status()">
                                               ...
                                               <!--<option value="7" @if($rider_run_detail->status == 7) selected ="" @endif >Run Complete</option>-->
                                                <!--<option value="5" @if($rider_run_detail->status != 6 && $rider_run_detail->status != 7) selected ="" @endif >Run Reject</option>-->
                                                 ...
                                                 <option value="7" @if($rider_run_detail->status == 7 || $rider_run_detail->status == 2) selected ="" @endif >Run Complete</option>
                                                <option value="5" @if($rider_run_detail->status != 6 && $rider_run_detail->status != 7 && $rider_run_detail->status != 2) selected ="" @endif >Run Reject</option>
