                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.area.create') }}" class="btn btn-success float-right">
                            <i class="fa fa-pencil-alt"></i> Add Area
                        </a>

                        <a href="{{ route('admin.area.excelImport') }}" class="btn btn-success float-right" style="margin-right: 20px;">
                        ...
                        <table id="yajraDatatable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <!--<th  class="text-center"> Pathao City </th>-->
                                    <!--<th  class="text-center"> Pathao Zone </th>-->
                                    <!--<th  class="text-center"> Pathao Area </th>-->
    ...
    window.onload = function(){
        ...
        var table = $('#yajraDatatable').DataTable({
            ...
            columns: [
                ...
                // { data: 'pathao_city', name: 'pathao_city', class : "text-center" },
                // { data: 'pathao_zone', name: 'pathao_zone', class : "text-center" },
                // { data: 'pathao_area', name: 'pathao_area', class : "text-center" },
        ...
        $('#yajraDatatable').on('click', '.delete-btn', function(){
            ...
            var sttaus = confirm("Are you sure delete this area?");
