...
@section('main')
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Approved Transaction</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <fieldset class="scheduler-border">
        <legend class="scheduler-border">Approved Transaction</legend>
        <!-- data table start -->
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('.datatable').DataTable({
                ...
                ajax: "{{ route('transaction.approved.datatable') }}",
                columns: [
