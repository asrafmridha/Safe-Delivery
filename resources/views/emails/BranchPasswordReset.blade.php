...
<html >
   <head>
      ...
      <title> Branch Reset Password Link </title>
   </head>
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 14px;
                                            ...
                                            <a href="{{ url('branch/resetPassword').'/'.$data['token'] }}" target="_blank"> {{ url('branch/resetPassword').'/'.$data['token'] }} </a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
