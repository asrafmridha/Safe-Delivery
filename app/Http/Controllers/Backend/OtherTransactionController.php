...
//        if ($request->ajax()) {
        $data = Transaction::orderBy('id', 'desc')->where('transaction_for',"other")->with('client', 'currency', 'user')->get();
...
//        }
    ...
    public function index(Request $request)
    {
        ...
        $clients = Client::all();
        return view('backend.transactions.other.index', compact('users', 'currencies', 'clients'));
    }
...
//        dd($request->all());
        ...
        $items = $model->get();
//        dd($filter);
        return view('backend.transactions.other.filter', compact('items', 'users', 'currencies', 'clients', 'filter'));
    }
    public function print(Request $request)
    {
        ...
        $items = $model->get();
//        dd($filter);
        return view('backend.transactions.other.print_filter', compact('items', 'users', 'currencies', 'clients', 'filter'));
