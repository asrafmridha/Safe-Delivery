...
<html >
   <head>
      ...
      <title> Merchant Reset Password Link </title>
   </head>
                                ...
                                <tr>
                                    <td class="content-cell"
                                                            ...
                                                            box-sizing: border-box;">
                                                                <tr>
                                                                    <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                                        <a href="{{ url('merchant/resetPassword').'/'.$data['token'] }}"
                                        ...
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 14px;
                                            ...
                                            <a href="{{ url('merchant/resetPassword').'/'.$data['token'] }}" target="_blank"> {{ url('merchant/resetPassword').'/'.$data['token'] }} </a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
