                        ...
                        <table id="yajraDatatable" class="table table-bordered table-striped ">
                            <thead>
                                <tr>
                                    ...
                                    <th width="15%" class="text-center"> Total Parcel </th>
                                    <th width="15%" class="text-center"> Total Complete Parcel </th>
    ...
    window.onload = function(){
        ...
        function load_data(status = '', from_date = '', to_date = ''){
            var table = $('#yajraDatatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url:'{!! route('merchant.parcel.getParcelPickupRequestList') !!}',
                    data:{
                        status       : status,
                        from_date    : from_date,
                        to_date      : to_date,
        ...
        $('#yajraDatatable').on('click', '.view-modal', function(){
            ...
            var url = "{{ route('merchant.parcel.viewParcelPickupRequest', ":parcel_pickup_request_id") }}";
