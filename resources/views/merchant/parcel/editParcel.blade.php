                                                        ...
                                                        <div class="row">
                                                            ...
                                                            {{-- <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="pickup_address" id="pickup_address" value="{{ $parcel->pickup_address }}" class="form-control" placeholder="Pickup Address" required>
                                                                </div>
                                                            </div> --}}
                                                            ...
                                                            <!--                    data-charge="{{$serviceType->rate}}">{{ $serviceType->title }} Extra {{$serviceType->rate}} TK</option>-->
                                                            <!--            @endforeach-->
                                                            <!--        </select>-->
                                                            <!--</div>-->
                                                            ...
                                                            <!--                <option-->
                                                            <!--                    value="{{ $itemType->id }}"-->
                                                            <!--                    data-charge="{{$itemType->rate}}">{{ $itemType->title }} Extra {{$itemType->rate}} TK</option>-->
                                                            <!--            @endforeach-->
                                                            <!--        </select>-->
                                                            <!--    </div>-->
                                                            <!--</div>-->
