...
<html >
   <head>
      ...
      <title> Merchant Email Verification Link </title>
   </head>
                                ...
                                <tr>
                                    <td class="content-cell"
                                                            ...
                                                            box-sizing: border-box;">
                                                                <tr>
                                                                    <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                                        <a href="{{ url('merchant/emailVerification').'/'.$merchant->email_verifications->token }}"
                                        ...
                                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 14px;
                                            ...
                                            <a href="{{ url('merchant/emailVerification').'/'.$merchant->email_verifications->token }}" target="_blank"> {{ url('merchant/emailVerification').'/'.$merchant->email_verifications->token }} </a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
