...
<div class="">
    ...
    <div class="right">
        ...
        @endif
        @if(key_exists('delivery_branch_id',$filter))
            <p class="text-right"><strong>Delivery Branch: </strong>
                @php
                    $branch = \App\Models\Branch::find($filter['delivery_branch_id']);
                @endphp
                @if($branch)
                    {{$branch->name}}
                @endif
        ...
        @if(key_exists('parcel_invoice',$filter))
            <p class="text-right"><strong>Bar Code: </strong>
