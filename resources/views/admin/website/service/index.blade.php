            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.service.create') }}" class="btn btn-success float-right">
                            <i class="fa fa-pencil-alt"></i> Add Service
                        </a>
                    </div>
                    <div class="card-body">
  ...
  <script>
    window.onload = function(){
        ...
        var table = $('#yajraDatatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('admin.service.getServices') !!}',
            columns: [
        ...
        $('#yajraDatatable').on('click', '.view-modal', function(){
            ...
            var url = "{{ route('admin.service.show', ":service_id") }}";
        ...
        $('#yajraDatatable').on('click', '.updateStatus', function(){
            ...
            var service_id  = status_object.attr('service_id');
            var status    = status_object.attr('status');
            var url       = "{{ route('admin.service.updateStatus') }}";
        ...
        $('#yajraDatatable').on('click', '.delete-btn', function(){
            ...
            var sttaus = confirm("Are you sure delete this service?");
