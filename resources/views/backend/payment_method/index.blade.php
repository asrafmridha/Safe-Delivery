                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Payment method list</li>
                            @if(check_permission('currency create'))
                                <a href="{{route('payment.method.create')}}" class="btn btn-primary ml-auto">
        ...
        $(function () {
            var table = $('.datatable').DataTable({
               ...
               /* pageLength: 50,
                ...
                ajax: "{{ route('payment.method.datatable') }}",
                columns: [
