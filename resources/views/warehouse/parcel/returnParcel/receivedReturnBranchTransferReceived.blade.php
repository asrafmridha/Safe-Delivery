...
<div class="modal-body">
    <form role="form" action="{{ route('branch.parcel.confirmReceivedReturnBranchTransferReceived', $returnBranchTransfer->id) }}" id="confirmAssignDeliveryBranch" method="POST" enctype="multipart/form-data" onsubmit="return createForm(this)">
        <input type="hidden" name="total_transfer_received_parcel" id="total_transfer_received_parcel" value="{{ $returnBranchTransfer->total_transfer_parcel }}">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <table class="table table-style">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10%"> : </td>
                                    <td style="width: 50%" id="view_total_transfer_received_parcel"> {{ $returnBranchTransfer->total_transfer_parcel }} </td>
                                </tr>
                                <tr>
                            ...
                            <table class="table table-style table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <select name="return_branch_transfer_status[]"  class="form-control select2 return_branch_transfer_status" style="width: 100%" onchange="return return_branch_transfer_status()">
                                                <option value="3">Transfer Received</option>
                                                <option value="4">Transfer Reject</option>
                                            </select>
                                            <input type="hidden" name="return_branch_transfer_details_id[]" class="return_branch_transfer_details_id" value="{{$return_branch_transfer_detail->id }}">
                                            <input type="hidden" name="parcel_id[]" class="parcel_id" value="{{$return_branch_transfer_detail->parcel_id }}">
                                        </td>
                                        <td class="text-center">
