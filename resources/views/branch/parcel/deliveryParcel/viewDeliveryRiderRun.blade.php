                        ...
                        <table class="table table-style table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @php
                                            if($rider_run_detail->parcel->delivery_type != null){
                                                switch($rider_run_detail->parcel->delivery_type){
                                                    case 1 :  $status = "Complete"; break;
                                                    case 2 :  $status = "Partial Delivery"; break;
                                                    case 3 :  $status = "Reschedule"; break;
