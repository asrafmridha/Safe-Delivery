...
@section('main')
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Pending Internal Transaction</li>
    ...
    <fieldset class="scheduler-border">
        <legend class="scheduler-border">Pending Internal Transaction</legend>
        <!-- data table start -->
        ...
        $(function () {
            var table = $('.datatable').DataTable({
               ...
               /* pageLength: 50,
                ...
                ajax: "{{ route('internal.transaction.pending.datatable') }}",
                columns: [
