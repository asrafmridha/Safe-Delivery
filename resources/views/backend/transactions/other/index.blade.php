...
@section('main')
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Other Transaction</li>
    ...
    <fieldset class="scheduler-border">
        <legend class="scheduler-border">Other Transaction</legend>
        <form action="{{route('transaction.other.filter')}}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-11">
                    <div class="row">
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('.datatable').DataTable({
                ...
                ajax: "{{ route('transaction.other.datatable') }}",
                columns: [
                    {data: 'DT_RowIndex', name: '#', orderable: false, searchable: false},
                    {data: 'date', name: 'date', class : "text-center"},
                    {data: 'transaction_no', name: 'transaction_no', class : "text-center"},
                    {data: 'transaction_for', name: 'transaction_for', class : "text-center text-capitalize"},
                    // {data: 'client.name', name: 'client.name', class : "text-center",render: (data, type, row) =>  (row && row.client && row.client.name)? data : "--"},
                    // {data: 'user.name', name: 'user.name',  class : "text-center",render: (data, type, row) =>  (row && row.user && row.user.name)? data : "--"},
                    {data: 'currency.code', name: 'currency', class : "text-center"},
                    {data: 'amount', name: 'amount', class : "text-center"},
                    {data: 'rate', name: 'rate', class : "text-center"},
                    {data: 'bdt_amount', name: 'bdt_amount', class : "text-center"},
                    {data: 'transaction_type', name: 'transaction_type', class : "text-center"},
