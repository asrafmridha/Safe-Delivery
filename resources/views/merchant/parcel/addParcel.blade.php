                                                ...
                                                <div class="col-md-12">
                                                    <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="product_value">Product Value (optional)</label>
                                                                    <input type="number" name="product_value"
                                                                           id="product_value"
                                                                           value="{{ old('product_value') }}"
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="product_details">Product Details (optional)</label>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="parcel_note">Special Instructions (optional)</label>
                                                                    <textarea name="parcel_note" id="parcel_note"
                                                                              class="form-control"
                                                                              placeholder="Parcel Special Instructions Note"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </fieldset>
