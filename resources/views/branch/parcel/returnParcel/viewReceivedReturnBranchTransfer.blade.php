<div class="modal-header bg-default">
    <h4 class="modal-title">Return Branch Transfer Information View </h4>
        ...
        <div class="row">
            <div class="col-md-12">
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <table class="table table-style">
                            ...
                            <tr>
                                ...
                                <td style="width: 10%"> : </td>
                                <td style="width: 50%"> {{ $returnBranchTransfer->total_transfer_received_parcel }} </td>
                            </tr>
                            <tr>
                                ...
                                @switch($returnBranchTransfer->status)
                                    @case(1) <div class="badge badge-success">Transfer  </div> @break
                                    ...
                                    @case(4) <div class="badge badge-danger " >Transfer Reject </div> @break
                                    @default
                                @endswitch
                                </td>
                            </tr>
                    ...
                    <fieldset>
                        <legend>Return Transfer Parcel</legend>
