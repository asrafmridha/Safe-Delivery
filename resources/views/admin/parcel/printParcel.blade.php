...
<div class="div-table" >
    <div class="div-table-row">
         <div class="div-table-col" style="width: 100%; height:35px; text-align: Center; font-size: 20px; margin-left: -1px; ">
...
<p style="font-size: 7px; margin-right: 2px"> Powered by: <b>{{ $application->name }}</b></p>
</div>
