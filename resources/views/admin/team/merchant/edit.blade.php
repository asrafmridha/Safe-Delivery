                                    ...
                                    <form role="form" action="{{ route('admin.merchant.update', $merchant->id) }}" method="POST"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="branch_id"> Pickup Branch <span style="font-weight: bold; color: red;">*</span> </label>
                                                ...
                                                <div class="col-md-6">
                                                    <label for="on_board_branch_id"> Reffer Agent <span style="font-weight: bold; color: red;"></span> </label>
                                                    <select name="on_board_branch_id" id="on_board_branch_id" class="form-control select2" style="width: 100%">
                                                        <option value="0">Select Reffer Agent</option>
                                                        @foreach ($branches as $branch)
                                                        <option value="{{ $branch->id }}">{{ $branch->name }}</option>
                                                        @endforeach
                                                    </select>
...
<script>
    ...
    @endif
     ...
     @if($merchant->on_board_branch_id)
        $("#on_board_branch_id").val('{{ $merchant->on_board_branch_id }}');
    @endif
