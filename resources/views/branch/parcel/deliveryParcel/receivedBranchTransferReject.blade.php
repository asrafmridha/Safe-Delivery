<div class="modal-header bg-default">
    <h4 class="modal-title">Received Branch Transfer Reject </h4>
    <button type="button" class="close bg-danger" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>
<div class="modal-body">
    <form role="form" action="{{ route('branch.parcel.confirmReceivedBranchTransferReject', $deliveryBranchTransfer->id) }}" id="confirmAssignDeliveryBranch" method="POST" enctype="multipart/form-data" onsubmit="return createForm(this)">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <table class="table table-style">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10%"> : </td>
                                    <td style="width: 50%" id="view_total_transfer_received_parcel"> {{ $deliveryBranchTransfer->total_transfer_received_parcel }} </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th >Note </th>
                                    <th colspan="2">
                                        <textarea name="transfer_note" class="form-control" placeholder="Transfer Transfer Note">{{ $deliveryBranchTransfer->note }}</textarea>
                                    </th>
                                </tr>
                            </table>
                            </div>
                            ...
                            <table class="table table-style table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="12.5%" class="text-center">Merchant Contact Number</th>
                                        <th width="15%" class="text-center">Customer Name</th>
                                        <th width="12.5%" class="text-center">Customer Contact Number</th>
                                    </tr>
                                </thead>
                                <tbody>
