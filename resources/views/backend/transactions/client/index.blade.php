...
@section('main')
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Client Transaction</li>
    ...
    <fieldset class="scheduler-border">
        <legend class="scheduler-border">Client Transaction</legend>
        <form action="{{route('transaction.client.filter')}}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-11">
                    <div class="row">
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('.datatable').DataTable({
                ...
                ajax: "{{ route('transaction.client.datatable') }}",
                columns: [
