            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.designation.create') }}" class="btn btn-success float-right">
                            <i class="fa fa-pencil-alt"></i> Add Designation
                        </a>
                    </div>
                    <div class="card-body">
  ...
  <script>
    window.onload = function(){
        ...
        var table = $('#yajraDatatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('admin.designation.getDesignations') !!}',
            columns: [
        ...
        $('#yajraDatatable').on('click', '.updateStatus', function(){
            ...
            var designation_id  = status_object.attr('designation_id');
            var status          = status_object.attr('status');
            var url             = "{{ route('admin.designation.updateStatus') }}";
        ...
        $('#yajraDatatable').on('click', '.delete-btn', function(){
            var status_object = $(this);
            var designation_id   = status_object.attr('designation_id');
            var url         = "{{ route('admin.designation.delete') }}";

            var sttaus = confirm("Are you sure delete this designation?");
