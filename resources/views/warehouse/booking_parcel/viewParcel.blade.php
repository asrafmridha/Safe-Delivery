                                ...
                                <table class="table table-style table-bordered">
                                    ...
                                    @foreach ($booking_parcel->booking_items as $booking_item)
                                        <tr>
                                            ...
                                            <td>{{ $booking_item->item ? $booking_item->item->item_categories->name : "Others" }}</td>
                                            <td>{{ $booking_item->item ? $booking_item->item->item_name : $booking_item->item_name }}</td>
                                            <td>{{ $booking_item->item ? $booking_item->item->units->name : $booking_item->unit_name }}</td>
                                            <td>{{ number_format($booking_item->unit_price,2) }}</td>
                                            <td>{{ $booking_item->quantity }}</td>
                                            <td>{{ number_format($booking_item->total_item_price,2) }}</td>
                                        </tr>
                                    @endforeach
                                </table>
                            </fieldset>
