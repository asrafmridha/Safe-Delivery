            ...
            <div class="col-md-12">
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Create New Service Area Setting</h3>
                    ...
                    <div class="card-body">
                        <div class="col-md-offset-1 col-md-10 ">
                            <div class="card card-primary">
                                <form role="form" action="{{ route('admin.serviceAreaSetting.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return createForm()">
                                  @csrf
                                    <div class="card-body">
                                            ...
                                            @foreach ($weightPackages as $weightPackage)
                                                <div class="col-md-3" style="margin-bottom: 15px ">
                                                    ...
                                                    <input class="form-control" type="number" disabled
                                                        name="rate[]" step="any" value="{{ $weightPackage->rate }}"
