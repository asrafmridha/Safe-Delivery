...
<div class="wrapper">
    ...
    @include('layouts.warehouse_layout.warehouse_header')

    @include('layouts.warehouse_layout.warehouse_sidebar')

    <div class="content-wrapper">
      @include('layouts.warehouse_layout.warehouse_session_alert')
      @yield('content')
    </div>

    @include('layouts.warehouse_layout.warehouse_footer')
