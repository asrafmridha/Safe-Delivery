...
@section('main')
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('payment.method')}}" class="breadcrumb-link">Payment Method</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Payment method create</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <fieldset class="scheduler-border">
        <legend class="scheduler-border">Create payment method</legend>
        <form action="{{route('payment.method.create')}}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-4">
