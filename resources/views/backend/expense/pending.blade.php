...
@section('main')
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Pending Expense</li>
    ...
    <fieldset class="scheduler-border">
        <legend class="scheduler-border">Pending Expense</legend>
        <!-- data table start -->
        ...
        $(function () {
            var table = $('.datatable').DataTable({
               ...
               /* pageLength: 50,
                ...
                ajax: "{{ route('expense.pending.datatable') }}",
                columns: [
