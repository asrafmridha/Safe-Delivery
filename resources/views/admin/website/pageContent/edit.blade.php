                        ...
                        <div class="card-body">
                            <div class="col-md-offset-1 col-md-10 ">
                                <div class="card card-primary">
                                    <form role="form" action="{{ route('admin.pageContent.update', $pageContent->id) }}" method="POST"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="short_details" id="short_details" class="form-control" placeholder="Page Content Short Details" >{{ $pageContent->short_details ?? old('short_details') }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="long_details">Long Details</label>
                                                <textarea type="text" name="long_details" id="long_details" class="form-control textarea" placeholder="Page Content Long Details" >{{ $pageContent->long_details ??  old('long_details') }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div id="preview_file_image" style="margin-top: 10px;">
                                                    @if ($pageContent->image != null)
                                                        <img src="{{ asset('uploads/pageContent/' . $pageContent->image) }}"
...
<script src="{{ asset('plugins/summernote/summernote-bs4.min.js') }}"></script>
    <script>
        $("#page_type").val('{{ $pageContent->page_type }}');
        $(function () {
            $('.textarea').summernote({
