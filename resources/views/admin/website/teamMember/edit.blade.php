            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.teamMember.index') }}">Team Member</a></li>
                        ...
                        <div class="card-body">
                            <div class="col-md-offset-1 col-md-10 ">
                                <div class="card card-primary">
                                    <form role="form" action="{{ route('admin.teamMember.update', $teamMember->id) }}" method="POST"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="name" value="{{ $teamMember->name ?? old('name') }}" class="form-control" placeholder="Member Name" >
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="message" id="message" class="form-control" placeholder="Message" >{{ $teamMember->message ??  old('message') }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if ($teamMember->image != null)
                                                    <img src="{{ asset('uploads/teamMember/' . $teamMember->image) }}"
...
<script>
        $("#designation_id").val('{{ $teamMember->designation_id}}');


        $(function () {
            $('.textarea').summernote({
                placeholder: 'Enter Team member message',
                height: 200
            })
        });
