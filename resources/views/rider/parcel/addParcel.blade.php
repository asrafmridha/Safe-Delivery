                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 50%"> 
                                                            <span id="view_cod_percent">
                                                                @php 
                                                                    $cod_percent = ($merchant->cod_charge != 0)? $merchant->cod_charge : $merchant->district->service_area->cod_charge;
                                                                    echo $cod_percent;
                                                                @endphp
                                                                %
                                                            </span>
                                                        <input type="hidden" id="confirm_cod_percent" name="cod_percent" value="{{ $cod_percent }}">
                                                        </td>
                                                    </tr>
                                                    <tr>
    ...
    window.onload = function(){
        $('#district_id').on('change', function(){
            ...
            $.ajax({
                ...
                url       : "{{ route('weightPackage.weightPackageOption') }}",
                success   : function(response){
                    $("#weight_package_id").html(response.option).attr('disabled', false);
                }
            });
