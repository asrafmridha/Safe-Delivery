            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.item.type') }}">Item Type List</a>
                        </li>
                ...
                <div class="col-md-6">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Create New Item Type</h3>
                        ...
                        <div class="card-body">
                            <div class="col-md-offset-1 p-3">
                                <div class="card card-primary">
                                    <form role="form" action="{{route('admin.item.type.create')}}" method="POST"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" id="title" value="{{ old('title') }}"
                                                       class="form-control" placeholder="Item Type Title">
                                            </div>
                                            <div class="form-group">
