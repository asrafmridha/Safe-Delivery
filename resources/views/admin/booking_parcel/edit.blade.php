...
@push('style_css')
    <style>
        ...
        <?php
            if($bookingParcel->rider_id != 0 || "" != $bookingParcel->rider_id) {
                ?>
                    #rider{
                        pointer-events: auto;
                        opacity: 0.5;
                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Edit Booking Parcel </h3>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="booking_parcel_type"
                                                        ...
                                                        <?php
                                                            ...
                                                            foreach($booking_types as $btype_key=>$btype_val) {

                                                                $selected = "";
                                                                if($bookingParcel->booking_parcel_type == $btype_key) {
                                                                    $selected = "selected";
                                                                }

                                                                echo '<option value="'.$btype_key.'" '.$selected.'>'.$btype_val.'</option>';
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="merchant_id"
                                                        ...
                                                        @foreach ($merchants as $merchant)
                                                            @php
                                                                $selected = "";
                                                                if($bookingParcel->merchant_id == $merchant->id) {
                                                                    $selected = "selected";
                                                                }
                                                            @endphp
                                                            <option value="{{ $merchant->id }}"
                                                                    data-address="{{ $merchant->address }}"
                                                                    data-contact_number="{{ $merchant->contact_number }}" {{ $selected }}>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="pickup"
                                                        ...
                                                        <option value="yes" <?php if($bookingParcel->rider_id != 0 || "" != $bookingParcel->rider_id) echo "selected"; ?>>Yes</option>
                                                    </select>
                                                </div>
                                                    ...
                                                    <div id="rider">
                                                        <select class="form-control select2" name="rider_id"
                                                            ...
                                                            @foreach ($riders as $rider)
                                                                @php
                                                                    $selected = "";
                                                                    if($bookingParcel->rider_id == $rider->id) {
                                                                        $selected = "selected";
                                                                    }
                                                                @endphp
                                                                <option value="{{ $rider->id }}" {{ $selected }}>{{ $rider->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="sender_phone" id="sender_phone"
                                                                       value="{{ $bookingParcel->sender_phone }}" class="form-control"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="sender_address" id="sender_address"
                                                                       value="{{ $bookingParcel->sender_address }}" class="form-control"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="sender_name" id="sender_name"
                                                                       value="{{ $bookingParcel->sender_name }}" class="form-control"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="sender_nid" id="sender_nid"
                                                                       value="{{ $bookingParcel->sender_nid }}" class="form-control"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="sender_division_id"
                                                                    ...
                                                                    @foreach ($divisions as $division)
                                                                        @php
                                                                            $selected = "";
                                                                            if($bookingParcel->sender_division_id == $division->id) {
                                                                                $selected = "selected";
                                                                            }
                                                                        @endphp
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="sender_district_id"
                                                                    ...
                                                                    @foreach ($sender_districts as $district)
                                                                        @php
                                                                            $selected = "";
                                                                            if($bookingParcel->sender_district_id == $district->id) {
                                                                                $selected = "selected";
                                                                            }
                                                                        @endphp
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="sender_thana_id"
                                                                    ...
                                                                    @foreach ($sender_upazilas as $thana)
                                                                        @php
                                                                            $selected = "";
                                                                            if($bookingParcel->sender_thana_id == $thana->id) {
                                                                                $selected = "selected";
                                                                            }
                                                                        @endphp
                                                                        <option value="{{ $thana->id }}" {{ $selected }}>{{ $thana->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="sender_area_id"
                                                                    ...
                                                                    @foreach ($sender_areas as $area)
                                                                        @php
                                                                            $selected = "";
                                                                            if($bookingParcel->sender_area_id == $area->id) {
                                                                                $selected = "selected";
                                                                            }
                                                                        @endphp
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="receiver_phone" id="receiver_phone"
                                                                       value="{{ $bookingParcel->receiver_phone }}" class="form-control"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="receiver_name" id="receiver_name"
                                                                       value="{{ $bookingParcel->receiver_name }}" class="form-control"
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="receiver_address" id="receiver_address"
                                                                       value="{{ $bookingParcel->receiver_address }}" class="form-control"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="receiver_division_id" style="width: 100%"
                                                                    ...
                                                                    @foreach ($divisions as $division)
                                                                        @php
                                                                            $selected = "";
                                                                            if($bookingParcel->receiver_division_id == $division->id) {
                                                                                $selected = "selected";
                                                                            }
                                                                        @endphp
                                                                        <option value="{{ $division->id }}" {{ $selected }}>{{ $division->name }}
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="receiver_district_id"
                                                                    ...
                                                                    @foreach ($receiver_districts as $district)
                                                                        @php
                                                                            $selected = "";
                                                                            if($bookingParcel->receiver_district_id == $district->id) {
                                                                                $selected = "selected";
                                                                            }
                                                                        @endphp
                                                                        <option value="{{ $district->id }}" {{ $selected }}>{{ $district->name }}
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="receiver_thana_id"
                                                                    ...
                                                                    <option value="0">Select Upazila/Thana</option>
                                                                    @foreach ($receiver_upazilas as $thana)
                                                                        @php
                                                                            $selected = "";
                                                                            if($bookingParcel->receiver_thana_id == $thana->id) {
                                                                                $selected = "selected";
                                                                            }
                                                                        @endphp
                                                                        <option value="{{ $thana->id }}" {{ $selected }}>{{ $thana->name }}
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="receiver_area_id"
                                                                    ...
                                                                    @foreach ($receiver_areas as $area)
                                                                        @php
                                                                            $selected = "";
                                                                            if($bookingParcel->receiver_area_id == $area->id) {
                                                                                $selected = "selected";
                                                                            }
                                                                        @endphp
                                                                        <option value="{{ $area->id }}" {{ $selected }}>{{ $area->name }}
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2" name="receiver_branch_id"
                                                                    ...
                                                                    @foreach ($branches as $branch)
                                                                        @php
                                                                            $selected = "";
                                                                            if($bookingParcel->receiver_branch_id == $branch->id) {
                                                                                $selected = "selected";
                                                                            }
                                                                        @endphp
                                                                        {{--@if ($branch->id != auth()->guard('branch')->user()->branch_id )--}}
                                                                            <option value="{{ $branch->id }}" data-condition="{{ $branch->cod_status }}" data-general="{{ $branch->general_status }}" {{ $selected }}>{{ $branch->name }}</option>
                                                                        {{--@endif--}}
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div id="d_type" style="pointer-events: none; opacity: 0.5">
                                                                    <select class="form-control select2" name="delivery_type"
                                                                            id="delivery_type">
                                                                        <option value="0">Select Type</option>
                                                                        <?php
                                                                        $delivery_types  = [
                                                                            'od'        => 'Office Delivery (OD)',
                                                                            'tod'      => 'Transit Office Delivery (TOD)',
                                                                            'hd'      => 'Home Delivery (HD)',
                                                                            'thd'   => 'Transit Home Delivery (THD)'
                                                                        ];

                                                                        foreach($delivery_types as $dtype_key=>$dtype_val) {

                                                                            $selected = "";
                                                                            if($bookingParcel->delivery_type == $dtype_key) {
                                                                                $selected = "selected";
                                                                            }

                                                                            echo '<option value="'.$dtype_key.'" '.$selected.'>'.$dtype_val.'</option>';
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="note" id="note" value="{{ $bookingParcel->note }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" id="item_list" class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    @foreach ($bookingParcel->booking_items as $booking_item)
                                                        <tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="3" rowspan="10" style="text-align:left;">
                                                            <table class="table cod_area" style="margin-top:20px;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> : </td>
                                                                    <td>
                                                                        <input type="text" name="collection_amount" id="collection_amount" value="{{ $bookingParcel->collection_amount }}" placeholder="Enter Collection Amount" onkeyup="calculate_cod_charge(this.value)" class="form-control">
                                                                        <input type="hidden" id="old_collection_amount" value="{{ $bookingParcel->collection_amount }}" placeholder="Enter Collection Amount" onkeyup="calculate_cod_charge(this.value)" class="form-control">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Cod Charge</th>
                                                                    <td> : </td>
                                                                    <td>
                                                                        <span id="view_cod_charge">{{ $bookingParcel->cod_amount }}</span>
                                                                        <input type="hidden" id="confirm_cod_charge" name="cod_amount" value="{{ $bookingParcel->cod_amount }}">
                                                                        <input type="hidden" id="old_cod_charge" value="{{ $bookingParcel->cod_amount }}">
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                        ...
                                                        <th style="text-align:left;">
                                                            <input type="text" class="form-control" name="total_amount" id="total_amount" value="{{ $bookingParcel->total_amount }}" readonly="">
                                                        </th>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="text-align:left;">
                                                            <input type="text" class="form-control" name="vat_amount" id="vat_amount" value="{{ $bookingParcel->vat_amount }}" readonly="">
                                                        </th>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="text-align:left;">
                                                            <input type="text" class="form-control" name="grand_amount" id="grand_amount" value="{{ $bookingParcel->grand_amount }}" readonly="">
                                                        </th>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="text-align:left;">
                                                            <input type="number" step="any" min="0" class="form-control" name="discount_percent" id="discount_percent" value="{{ $bookingParcel->discount_percent }}" placeholder="Discount Percentage" onkeyUp="discount_percent_calculate(this.value)">
                                                        </th>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="text-align:left;">
                                                            <input type="number" step="any" min="0" class="form-control" name="discount_amount" id="discount_amount" value="{{ $bookingParcel->discount_amount }}" placeholder="Discount Amount" onkeyUp="discount_calculate(this.value)">
                                                        </th>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="text-align:left;">
                                                            <input type="text" class="form-control" name="net_amount" id="net_amount" value="{{ $bookingParcel->net_amount }}" placeholder="Net Amount" readonly="">
                                                        </th>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="text-align:left;">
                                                            <input type="text" class="form-control" name="pickup_charge" id="pickup_charge" value="{{ $bookingParcel->pickup_charge }}" readonly="" placeholder="Pickup Charge" onkeyup="pickup_charge_calculate(this.value)">
                                                        </th>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="text-align:left;">
                                                            <input type="text" class="form-control" name="total_payable" id="total_payable" value="{{ $bookingParcel->net_amount + $bookingParcel->pickup_charge }}" placeholder="Net Amount With Pickup" readonly="">
                                                        </th>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="text-align:left;">
                                                            <input type="number" step="any" min="0" class="form-control" name="paid_amount" id="paid_amount" value="{{ $bookingParcel->paid_amount }}" placeholder="Paid Amount" onkeyUp="paid_calculate(this.value)">
                                                        </th>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="text-align:left;">
                                                            <input type="text" class="form-control" name="due_amount" id="due_amount" value="{{ $bookingParcel->due_amount }}" placeholder="Due Amount" readonly="">
                                                        </th>
                                                    </tr>
                                                    </tbody>
                                                </table>
    ...
    <script>
        window.onload = function() {
            ...
            $("#booking_parcel_type").on('change', function () {
                var type    = $(this).val();
                var old_collection_amount = returnNumber($("#old_collection_amount").val());
                var old_cod_amount = returnNumber($("#old_cod_charge").val());
                if('condition' == type) {
                    $(".cod_area").css("display", "block");

                    $("#collection_amount").val(old_collection_amount);
                    $("#confirm_cod_charge").val(old_cod_amount);
                }else{
                    $(".cod_area").css("display", "none");
                    $("#collection_amount").val("");
                    $("#confirm_cod_charge").val("");
                }
        ...
        function submit_data() {
            ...
            $.ajax({
                url: "{{ route('admin.bookingParcel.update', $bookingParcel->id) }}",
                type: "POST",
                dataType: "json",
                ...
                success: function(data) {
                    if (data.success == true) {
                        toastr.success('Parcel Information Update Successfully');
                        window.location = "{{ route('admin.bookingParcel.index') }}";
                        //$('#preview_file').html('');
