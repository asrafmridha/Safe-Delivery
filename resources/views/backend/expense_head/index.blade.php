...
@section('main')
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Expense Head list</li>
                            @if(check_permission('expense head create'))
                                <a href="{{route('expense.head.create')}}" class="btn btn-primary ml-auto">
                                    Create Expense Head
                                </a>
                            @endif
                        </ol>
    ...
    <fieldset class="scheduler-border">
        <legend class="scheduler-border">Expense Head</legend>
        <!-- data table start -->
        ...
        $(function () {
            var table = $('.datatable').DataTable({
               ...
               /* pageLength: 50,
                ...
                ajax: "{{ route('expense.head.datatable') }}",
                columns: [
