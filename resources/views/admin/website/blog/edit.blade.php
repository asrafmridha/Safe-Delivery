                        ...
                        <div class="card-body">
                            <div class="col-md-offset-1 col-md-10 ">
                                <div class="card card-primary">
                                    <form role="form" action="{{ route('admin.blog.update', $blog->id) }}" method="POST"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" id="title" value="{{ $blog->title ?? old('title') }}" class="form-control" placeholder="Blog Title" >
                                            </div>
                                            <div class="form-group">
                                                <label for="short_details">Short Details</label>
                                                <textarea type="text" name="short_details" id="short_details" class="form-control" placeholder="Blog Short Details" >{{ $blog->short_details ?? old('short_details') }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="long_details">Long Details</label>
                                                <textarea type="text" name="long_details" id="long_details" class="form-control textarea" placeholder="Blog Long Details" >{{ $blog->long_details ??  old('long_details') }}</textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="date" id="date" value="{{ \Carbon\Carbon::parse($blog->date)->format('Y-m-d') ?? old('date') }}" class="form-control" placeholder="Blog Date" >
                                            </div>
                                        </div>
