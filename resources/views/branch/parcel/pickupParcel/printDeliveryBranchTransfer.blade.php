...
<head>
    ...
    <title>Delivery Branch Transfer</title>
    <style>
        table, td, th {
...
<div>
    <div class="center">
        ...
        <h4 class="text-center">Delivery Branch Transfer</h4>
        <p class="text-center"><strong>Consignment: </strong>{{ $deliveryBranchTransfer->delivery_transfer_invoice }}</p>
        <p class="text-center"><strong>Date: </strong>{{date('d M, Y')}}</p>
        <p class="text-center"><strong>From: </strong>{{ $deliveryBranchTransfer->from_branch->name }}<strong> - To: </strong>{{ $deliveryBranchTransfer->to_branch->name }}</p>
    </div>
    <fieldset>
                    ...
                    <tr>
                        ...
                        <td style="width: 50%">
                            @switch($deliveryBranchTransfer->status)
                                @case(1)
                                <div class="badge badge-success">Transfer Create</div> @break
                                @case(2)
                                <div class="badge badge-danger">Transfer Cancel</div> @break
                                @case(3)
                                <div class="badge badge-success ">Transfer Received</div> @break
                                @case(3)
                                <div class="badge badge-danger ">Transfer Reject</div> @break
                                @default
                            @endswitch
                        </td>
                    </tr>
            ...
            <fieldset>
                ...
                <table class="table table-style table-striped">
                    ...
                    <tr>
                        ...
                        <th width="15%" class="text-center">Collection Amount</th>
...
{{--                            <td class="text-center"> {{ $delivery_branch_transfer_detail->parcel->merchant->contact_number }} </td>--}}
                            ...
                            <td class="text-center"> {{ $delivery_branch_transfer_detail->parcel->customer_contact_number }} </td>
                            <td class="text-center"> {{ $delivery_branch_transfer_detail->parcel->customer_address }} </td>
                            <td class="text-center"> {{ $delivery_branch_transfer_detail->parcel->total_collect_amount }} </td>
