...
<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1 class="m-0 text-dark">Generate Pickup Rider Run </h1>
        </div>
        <div class="col-sm-6">
  ...
  <div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form role="form" action="{{ route('branch.parcel.confirmPickupRiderRunGenerate') }}" method="POST" enctype="multipart/form-data" onsubmit="return createForm()">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset>
                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <button type="reset" onclick="resetForm()" class="btn btn-primary">Reset</button>
                                </div>
                            </fieldset>
                        </div>
                        ...
                        <div class="col-md-12 row" style="margin-top: 20px;">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" name="merchant_order_id" id="merchant_order_id" class="form-control" placeholder="Enter Merchant Order ID / Customer Number " onkeypress="return add_parcel(event)"
                                    style="font-size: 20px; box-shadow: 0 0 5px rgb(62, 196, 118);
                                    padding: 3px 0px 3px 3px;
                                    margin: 5px 1px 3px 0px;
                                    border: 1px solid rgb(62, 196, 118);">
                            ...
                            <div class="col-md-3">
                                <div class="form-group merchantSelect">
                                    ...
                                    <select name="merchant_id" id="merchant_id" class="form-control select2" style="font-size: 20px; box-shadow: 0 0 5px rgb(62, 196, 118);
                                    padding: 3px 0px 3px 3px;
                                    margin: 5px 1px 3px 0px;
                                    border: 1px solid rgb(62, 196, 118);">
                                        ...
                                        {{--@endforeach--}}
                                        @foreach ($merchants as $merchant)
                                            <option value="{{ $merchant->merchant->id }}" > {{ $merchant->merchant->company_name }} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <button type="button" style="margin-top: 5px;" class="btn btn-info btn-block" onclick="return parcelResult()">
                                    Search
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12" style="margin-top: 20px;">
                            <table class="table table-bordered table-striped table-responsive"  style="background-color:white;width: 100%">
                                <thead>
                                    ...
                                    <tr  style="background-color: #a2bbca !important; font-family: Arial Black;font-size: 14px">
                                        ...
                                        <th width="15%" class="text-center">Pickup Address</th>
                                        <th width="13%" class="text-center">Customer Name</th>
                                        <th width="10%" class="text-center">Customer Number</th>
                                        <th width="12%" class="text-center">Collection Amount </th>
                                ...
                                <tbody id="show_parcel">
                                    ...
                                    @foreach($parcels as $parcel)
                                        <tr style="background-color: #f4f4f4;">
                                            ...
                                            <td class="text-center" >
                                                <a href="{{ route('parcel.printParcel', $parcel->id) }}" class="btn btn-success btn-sm" title="Print Parcel" target="_blank">
...
<script src="{{ asset('plugins/select2/js/select2.full.min.js') }}"></script>
  ...
  <script>
    ...
    window.onload = function(){
        ...
        $('#addParcelInvoice').on('click', function(){
            ...
            $.ajax({
                ...
                url       : "{{ route('branch.parcel.pickupRiderRunParcelAddCart') }}",
    ...
    function parcelResult(){
        ...
        let parcel_invoices=[parcel_invoice];
