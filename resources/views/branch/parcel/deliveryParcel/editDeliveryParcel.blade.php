...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Edit Delivery Parcel</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('branch.home') }}">Home</a></li>
                        <li class="breadcrumb-item active">Edit Delivery Parcel</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Edit Delivery Parcel </h3>
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <form role="form"
                                      action="{{ route('branch.parcel.confirmEditDeliveryParcel', $parcel->id) }}"
                                            ...
                                            <div class="col-md-12">
                                                <fieldset>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="service_type_id" id="service_type_id"
                                                                        class="form-control select2"
                                                                        style="width: 100%" {{$parcel->item_type_id ? "disabled":''}} >
                                                                    <option value="0">Select Service Type</option>
                                                                    @foreach ($serviceTypes as $serviceType)
                                                                        <option
                                                                            value="{{ $serviceType->id }}"
                                                                            data-charge="{{$serviceType->rate}}">{{ $serviceType->title }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="item_type_id" id="item_type_id"
                                                                    ...
                                                                    @foreach ($itemTypes as $itemType)
                                                                        <option
                                                                            value="{{ $itemType->id }}"
                                                                            data-charge="{{$itemType->rate}}">{{ $itemType->title }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label for="delivery_option_id"> Delivery
                                                                    Option </label>
    ...
    <script>
        ...
        window.onload = function () {
            ...
            $('#service_type_id').on('change', function () {
                ...
                if (item_type_id != 0) {
                    var charge = returnNumber($("#item_type_id option:selected").attr('data-charge'));
                    // Delivery Charge Comes from Service type Charge
                    $("#confirm_merchant_service_area_charge").val(charge);
                    $("#confirm_delivery_charge").val(charge);
                    $("#view_delivery_charge").html(returnNumber(charge).toFixed(2));
                    $("#service_type_id").html('').attr('disabled', true);
                } else if (service_type_id != 0) {
                    var charge = returnNumber($("#service_type_id option:selected").attr('data-charge'));
                    // Delivery Charge Comes from Service type Charge
                    $("#confirm_merchant_service_area_charge").val(charge);
                    $("#confirm_delivery_charge").val(charge);
                    $("#view_delivery_charge").html(returnNumber(charge).toFixed(2));
            ...
            $('#item_type_id').on('change', function () {
                ...
                if (item_type_id != 0) {
                    ...
                    $("#confirm_delivery_charge").val(charge);
                    $("#view_delivery_charge").html(returnNumber(charge).toFixed(2));
                    $("#service_type_id").html('').val(0).attr('disabled', true);
                } else if (service_type_id != 0) {
                    var charge = returnNumber($("#service_type_id option:selected").attr('data-charge'));
                    // Delivery Charge Comes from Service type Charge
                    $("#confirm_merchant_service_area_charge").val(charge);
