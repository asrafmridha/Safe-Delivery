  ...
  <script>
    window.onload = function(){
        var table = $('#yajraDatatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('branch.getCoverageAreas') !!}',
            columns: [
                { data: 'DT_RowIndex', orderable: false , searchable: false, class : "text-center"},
                { data: 'name', name: 'name', class : "text-center" },
                { data: 'post_code', name: 'post_code', class : "text-center" },
                { data: 'upazila.name', name: 'upazila.name', class : "text-center" },
                { data: 'upazila.district.name', name: 'upazila.district.name', class : "text-center"},
                { data: 'upazila.district.service_area.name', name: 'upazila.district.service_area.name', class : "text-center"},
                { data: 'upazila.district.service_area.cod_charge', name: 'upazila.district.service_area.cod_charge', class : "text-center"},
            ]
        });
    }
  </script>
