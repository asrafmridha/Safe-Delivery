                                    ...
                                    <form role="form" action="{{ route('admin.service.update', $service->id) }}" method="POST"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="name" value="{{ $service->name ?? old('name') }}" class="form-control" placeholder="Service Name" >
                                            </div>
                                            <div class="form-group">
                                                <label for="short_details">Short Details</label>
                                                <textarea type="text" name="short_details" id="short_details" class="form-control" placeholder="Service Short Details" >{{ $service->short_details ?? old('short_details') }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="long_details">Long Details</label>
                                                <textarea type="text" name="long_details" id="long_details" class="form-control textarea" placeholder="Service Long Details" >{{ $service->long_details ??  old('long_details') }}</textarea>
                                            </div>
                                            <div class="form-group">
