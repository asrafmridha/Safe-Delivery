                                    ...
                                    <form role="form" action="{{ route('admin.area.update', $area->id) }}" method="POST"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="name" value="{{ $area->name ?? old('name') }}" class="form-control" placeholder="Area Name" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="post_code">Post Code</label>
                                                <input type="text" name="post_code" id="post_code" value="{{ $area->post_code ??  old('post_code') }}" class="form-control" placeholder="Area Post Code" >
                                            </div>
                                        </div>
