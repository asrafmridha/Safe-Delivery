...
@section('main')
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Filter Other Transaction</li>
    ...
    <div id="printableArea">
        <fieldset class="scheduler-border">
            <legend class="scheduler-border">Other Transaction Filter</legend>
      ...
      /*  function printDiv(divName) {
        ...
        window.onload = function () {
            $(document).on('click', '#printBtn', function () {
                ...
                $.ajax({
                    type: 'GET',
                    url: '{!! route('transaction.other.print') !!}',
                    data: {
                        status: status,
