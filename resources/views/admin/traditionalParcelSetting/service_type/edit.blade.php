            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.service.type') }}">Service Type</a></li>
                        ...
                        <div class="card-body">
                            <div class="col-md-offset-1">
                                <div class="card card-primary">
                                    <form role="form" action="{{ route('admin.service.type.edit', $serviceType->id) }}"
                                          method="POST"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="rate">Extra Charge</label>
                                                <input type="number" name="rate" id="rate"
                                                       value="{{ $serviceType->rate }}"
                                                ...
                                                <select name="service_area_id" id="service_area_id"
                                                    ...
                                                    @if ($serviceAreas->count() > 0 )
                                                        @foreach ($serviceAreas as $serviceArea)
                                                            <option
                                                                value="{{ $serviceArea->id }}" {{$serviceArea->id == $serviceType->service_area_id?'selected':''}} >{{ $serviceArea->name }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
