...
<div class="div-table" >
    ...
    <!--   </div>-->
        ...
        <div class="div-table-col" style="width: 50%;margin-left: -1px; text-align: left">
            <strong style="margin-left: 5px"> Send by: </strong><br>
         <strong style="margin-left: 5px"> {{ $parcel->merchant->company_name }}</strong>
          <p style="margin-left: 5px"> {{ $parcel->merchant->contact_number }}</p>
          <p style="margin-left: 5px"> {{$parcel->area->name}}</p>
        </div>
        <div class="div-table-col" style="width: 50%;margin-right: -1px; text-align: left">
            <strong style="margin-left: 5px"> Send to: </strong><br>
            <strong style="margin-left: 5px">  {{$parcel->customer_name }}</strong><br>
    ...
    <div class="div-table-row" style="text-align: center;">
            ...
            <div class="div-table-col" style="width: 100%;height: 85px;margin-right: -1px">
            ...
            <p class="align-center"> PDL {{ $parcel->parcel_invoice }}</p>
            </div>

        <!--<div class="div-table-col" style="width: 50%;height: 85px;margin-right: -1px;padding-bottom: 1px">-->
        ...
        <div class="div-table-col" style="width: 100%;">
            Special Instruction: {{ $parcel->product_details }}
        </div>
    </div>
    ...
    <div class="div-table-row" style="text-align: center">
        ...
        <div class="div-table-col" style="width: 50%;margin-right: -1px">
            <strong>Weight   |   {{$parcel->weight_package_id}} KG</strong>
        </div>
        <div class="div-table-col" style="width: 50%;margin-right: -1px">
