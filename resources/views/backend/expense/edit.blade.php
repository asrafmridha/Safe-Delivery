...
@section('main')
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('expense')}}" class="breadcrumb-link">Expense
                                    </a>
                            </li>
    ...
    <fieldset class="scheduler-border">
        <legend class="scheduler-border">Edit Expense</legend>
        <form action="{{route('expense.edit',$data->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                        ...
                        <div class="col-md-5" >
                            ...
                            <select id="expense_head_id" name="expense_head_id"
                                ...
                                @foreach($expenseHeads as $expenseHead)
                                    <option value="{{$expenseHead->id}}" {{$data->expense_head_id == $expenseHead->id ? 'selected': ''}}>
                                        {{$expenseHead->title}}
                                    </option>
                                @endforeach
                            </select>
