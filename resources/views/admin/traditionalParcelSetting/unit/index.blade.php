                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('admin.unit.create') }}" class="btn btn-success float-right">
    ...
    <script>
        window.onload = function() {
            ...
            var table = $('#yajraDatatable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.unit.getUnits') }}",
                columns: [
            ...
            $('#yajraDatatable').on('click', '.view-modal', function() {
                ...
                var url = "{{ route('admin.unit.show', ':unit_id') }}";
            ...
            $('#yajraDatatable').on('click', '.updateStatus', function() {
                ...
                var unit_id = status_object.attr('unit_id');
                var status = status_object.attr('status');
                var url = "{{ route('admin.unit.updateStatus') }}";
            ...
            $(document).on('click', '#printBtn', function(){
                $.ajax({
                    type: 'GET',
                    url: '{!! route('admin.unit.printUnits') !!}',
                    data: {},
                    dataType: 'html',
