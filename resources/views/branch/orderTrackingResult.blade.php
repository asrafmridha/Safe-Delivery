                                        ...
                                        switch($parcelLog->status){
                                            ...
                                            case 26 :
                                                ...
                                                if(!empty($parcelLog->admin)){
                                                    ...
                                                    $to_user    = "Delivery Branch : ".$parcelLog->delivery_branch->name;
                                                    $from_user    = "Pickup Branch : ".optional($parcelLog->return_branch)->name;
                                                }
                                                break;
                                            case 27 :
                                                ...
                                                if(!empty($parcelLog->admin)){
                                                    ...
                                                    $to_user    = "Pickup Branch : ".optional($parcelLog->return_branch)->name;
                                                }
                                                break;
                                            case 28 :
                                                ...
                                                if(!empty($parcelLog->admin)){
                                                    ...
                                                    $to_user    = "Return Branch : ".optional($parcelLog->return_branch)->name;
                                                }
                                                break;
                                            case 29 :
                                            ...
                                            case 32 :
                                                ...
                                                if(!empty($parcelLog->admin)){
                                                    ...
                                                    $to_user    = "Return Rider : ".$parcelLog->delivery_rider->name;
                                                }
                                                break;
                                            case 33 :
