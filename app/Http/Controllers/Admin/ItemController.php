...
class ItemController extends Controller
{
    public function index() {
        ...
        return view('admin.traditionalParcelSetting.item.index', $data);
    }
...
//                                <i class="fa fa-eye"></i> </button> &nbsp;&nbsp;';
                $button = '<a href="' . route('admin.item.edit', $data->id) . '" class="btn btn-success btn-sm"> <i class="fa fa-edit"></i> </a>';
                $button .= '&nbsp;&nbsp;&nbsp; <button class="btn btn-danger btn-sm delete-btn" item_id="' . $data->id . '">
    ...
    public function printItems(Request $request) {
        $items = Item::with(['item_categories', 'units'])->get();
        return view('admin.traditionalParcelSetting.item.print', compact('items'));
        return DataTables::of($model)
            ->addIndexColumn()
            ->editColumn('status', function ($data) {
...
//                                <i class="fa fa-eye"></i> </button> &nbsp;&nbsp;';
    ...
    public function create() {
        ...
        return view('admin.traditionalParcelSetting.item.create', $data);
    }
    ...
    public function edit(Request $request, Item $item) {
        ...
        $data['units']  = Unit::where('status', 1)->get();
        $data['item']     = $item;
        return view('admin.traditionalParcelSetting.item.edit', $data);
    }
    ...
    public function destroy(Request $request, Item $item) {
        ...
        return redirect()->route('admin.traditionalParcelSetting.item.index');
    }
