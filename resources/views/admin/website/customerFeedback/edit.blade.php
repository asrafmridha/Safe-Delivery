                        ...
                        <div class="card-body">
                            <div class="col-md-offset-1 col-md-10 ">
                                <div class="card card-primary">
                                    <form role="form" action="{{ route('admin.customerFeedback.update', $customerFeedback->id) }}" method="POST"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="name" value="{{ $customerFeedback->name ?? old('name') }}" class="form-control" placeholder="Customer Name" >
                                            </div>
                                            <div class="form-group">
                                                <label for="company">Company </label>
                                                <input type="text" name="company" id="company" value="{{ $customerFeedback->company ??  old('company') }}" class="form-control" placeholder="Customer Company" >
                                            </div>

                                            <div class="form-group">
                                                <label for="feedback">Feedback</label>
                                                <textarea type="text" name="feedback" id="feedback" class="form-control" placeholder="Customer Feedback" >{{ $customerFeedback->feedback ??  old('feedback') }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div id="preview_file_image" style="margin-top: 10px;">
                                                    @if ($customerFeedback->image != null)
                                                        <img src="{{ asset('uploads/customerFeedback/' . $customerFeedback->image) }}"
