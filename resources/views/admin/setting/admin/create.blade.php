                                  ...
                                  @csrf
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="contact_number" id="contact_number"  value="{{ old('contact_number') }}" class="form-control"  placeholder="Enter phone" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="photo" id="photo"  class="form-control" accept="image/*" onchange="return filePreview(this)" >
                                        ...
                                        <div class="form-group">
                                          ...
                                          <select name="type" id="type" class="form-control select2" style="width: 100%">
                                            ...
                                            <option value="2" {{ old('type') == '2' ? 'selected':'' }}>Operation</option>
                                            <option value="3" {{ old('type') == '3' ? 'selected':'' }}>Accounts</option>
                                            <option value="4" {{ old('type') == '4' ? 'selected':'' }}>CS </option>
                                            <option value="5" {{ old('type') == '5' ? 'selected':'' }}>Business Development</option>
                                            <option value="6" {{ old('type') == '6' ? 'selected':'' }}>General User</option>
                                          </select>
                                        </div>
                                    </div>
