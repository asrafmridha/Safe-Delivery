...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form role="form" action="{{ route('branch.parcel.confirmDeliveryPaymentGenerateEdit', $parcelDeliveryPayment->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return createForm()">
                        @method('patch')
                        @csrf
                                ...
                                <table class="table table-bordered table-stripede"  style="background-color:white;width: 100%">
                                    ...
                                    @if($parcelDeliveryPayment->parcel_delivery_payment_details->count() > 0)
                                        @foreach($parcelDeliveryPayment->parcel_delivery_payment_details as $parcel_delivery_payment_detail)
                                            <tr style="background-color: #f4f4f4;">
                                                <td class="text-center" >
                                                    <input type="checkbox" id="checkItem"  class="parcelId"  value="{{ $parcel_delivery_payment_detail->parcel->id }}" >
                                                </td>
                                                <td class="text-center" >
                                                ...
                                                <td class="text-center" >
                                                    {{ $parcel_delivery_payment_detail->parcel->customer_contact_number }}
                                                </td>
                                                <td class="text-right" >
                                                    {{ number_format($parcel_delivery_payment_detail->parcel->customer_collect_amount,2) }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
