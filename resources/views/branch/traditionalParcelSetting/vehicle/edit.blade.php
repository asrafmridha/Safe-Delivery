                                    ...
                                    <form role="form" action="{{ route('admin.vehicle.update', $vehicle->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return createForm()">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="vehicle_name" id="vehicle_name" value="{{ $vehicle->vehicle_name ?? old('vehicle_name') }}" class="form-control" placeholder="Vehicle Name" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="vehicle_root" id="vehicle_root" value="{{ $vehicle->vehicle_root ?? old('vehicle_root') }}" class="form-control" placeholder="Vehicle Root" required>
                                            </div>
                                        </div>
