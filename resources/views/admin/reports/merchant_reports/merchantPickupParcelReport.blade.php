                    ...
                    <fieldset>
                        ...
                        <table class="table table-style table-striped">
                            ...
                            <tbody>
                                ...
                                $parcels = \App\Models\Parcel::where('merchant_id', $merchant_id)->whereDate('pickup_rider_date', \Carbon\Carbon::today())->get();

                                $total_quantity =\App\Models\Parcel::where('merchant_id', $merchant_id)->whereDate('pickup_rider_date', \Carbon\Carbon::today())->get()->count();
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 5%; text-align: center;"> :</td>
                                    <td class="text-center" style="width: 30%; text-align: center;">{{$total_collect_amo}}</td>
                                </tr>
                                @endif
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 30%; text-align: center;"> <b>{{ $total_qua }} </b>
                                    </td>
                                    <td class="text-center" style="width: 5%; text-align: center;"> <b> :</td> </b>
                                    <td class="text-center" style="width: 30%; text-align: center;"> <b> Tk :{{$total_amount}} /=</b>
