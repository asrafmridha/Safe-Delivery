                                        ...
                                        <div class="col-md-12">
                                            <fieldset>
                                              ...
                                              <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="return_branch_id"> Return Branch</label>
                                                            <select name="return_branch_id" id="return_branch_id" class="form-control select2" style="width: 100%">
                                                                <option value="0">Select Return Branch</option>
                                                                @foreach ($branches as $branch)
                                                                    <option value="{{ $branch->id }}">{{ $branch->name }}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="return_rider_id" id="return_rider_id" class="form-control select2" style="width: 100%">
                                                                ...
                                                                @if(!empty($returnRiders))
                                                                    @foreach ($returnRiders as $returnRider)
                                                                        <option value="{{ $returnRider->id }}">{{ $returnRider->name }}</option>
                                                                    @endforeach
                                                                @endif
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="status" style="color: red;">Parcel Status</label>
                                                            <select name="status" id="status" class="form-control select2" style="width: 100%">
                                                                <option value="1"> Pickup Request</option>
                                                                <option value="2"> Hold Parcel</option>
                                                                <option value="3"> Deleted </option>
                                                                <option value="4"> Re-schedule Pickup </option>
                                                                <option value="5"> Assign for Pickup </option>
                                                                <option value="6"> Rider Assign For Pick  </option>
                                                                <option value="7"> Pickup Run Cancel </option>
                                                                <option value="8"> On the way to Pickup </option>
                                                                <option value="9"> Pickup Rider Reject </option>
                                                                <option value="10"> Rider Picked </option>
                                                                <option value="11"> Picked Up  </option>
                                                                <option value="12"> On the Way To Delivery Hub</option>
                                                                <option value="13"> Branch Transfer Cancel</option>
                                                                <option value="14"> At Delivery Hub </option>
                                                                <option value="15"> Delivery Branch Reject</option>
                                                                <option value="16"> Assign For Delivery</option>
                                                                <option value="17"> Assign For Delivery Start</option>
                                                                <option value="18"> Delivery Run Cancel</option>
                                                                <option value="19"> On The Way To Delivery</option>
                                                                <option value="20"> Delivery Rider Reject</option>
                                                                <option value="21"> Rider Delivered</option>
                                                                <option value="22"> Rider Partially Delivered</option>
                                                                <option value="23"> Rider Rescheduled</option>
                                                                <option value="24"> Rider Return</option>
                                                                <option value="25"> Delivered Option </option>
                                                                <option value="26"> Return Transfer </option>
                                                                <option value="27"> Return Transfer Cancel </option>
                                                                <option value="28"> At Returned Hub </option>
                                                                <option value="29"> Return Transfer Reject </option>
                                                                <option value="30"> Return Run Create </option>
                                                                <option value="31"> Assign For Return start </option>
                                                                <option value="32"> Return Run Cancel </option>
                                                                <option value="33"> On The Way To Return </option>
                                                                <option value="34"> Return Run Rider Reject </option>
                                                                <option value="35"> Rider Returned </option>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="delivery_type" style="color: #0058ff;">Delivery Type</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="customer_collect_amount">Collected Amount</label>
                                                            <input type="number" name="customer_collect_amount" id="customer_collect_amount" value="{{ $parcel->customer_collect_amount }}" class="form-control" placeholder="0.00" >
                                                        </div>
                                                    </div>
...
<!--                                                    <div class="col-md-6 col-sm-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="total_collect_amount" id="total_collect_amount" value="{{ $parcel->total_collect_amount }}" class="form-control" step="any" placeholder="0.00" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                ...
                                                <table class="table ">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 50%">
                                                            ...
                                                            <input type="number" id="view_weight_package_charge" name="view_weight_package_charge" value="{{ number_format($parcel->weight_package_charge,2) }}">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 10%"> : </td>
                                                        <td style="width: 50%">
                                                            <span id="view_delivery_charge" style="display:none">{{ number_format($parcel->delivery_charge,2) }}</span>
                                                            <input type="number" id="confirm_delivery_charge" name="delivery_charge" value="{{ $parcel->delivery_charge }}">
...
<script src="{{ asset('plugins/select2/js/select2.full.min.js') }}"></script>
  <script>
      ...
      $("#return_branch_id").val({{ $parcel->return_branch_id }});
      $("#return_rider_id").val({{ $parcel->return_rider_id }});
      
      $("#status").val({{ $parcel->status }});
      $("#delivery_type").val({{ $parcel->delivery_type }});
    ...
    window.onload = function(){
        ...
        //New For Parcel Edit Start
            $('#view_weight_package_charge').on('change', function(){
                var view_weight_package_charge       = $("#view_weight_package_charge").val();
                $("#confirm_weight_package_charge").val(view_weight_package_charge);
               
                calculate_total_charge();
            });
            $('#confirm_delivery_charge').on('change', function(){
                calculate_total_charge();
            });
        //New For Parcel Edit end
