                    ...
                    <legend>Parcel Pickup Request Information</legend>
                        <table class="table table-style">
                            ...
                            <tr>
                                ...
                                <td style="width: 10%"> : </td>
                                <td style="width: 50%"> {{ $parcelPickupRequest->riders->name }} </td>
                            </tr>
                            <tr>
                                <th style="width: 40%">Rider Contact Number </th>
                                <td style="width: 10%"> : </td>
                                <td style="width: 50%"> {{ ($parcelPickupRequest->riders->contact_number) ? $parcelPickupRequest->riders->contact_number : "Not Available" }} </td>
                            </tr>
                            <tr>
