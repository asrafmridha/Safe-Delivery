                        ...
                        <table id="yajraDatatable" class="table table-bordered table-striped table-responsive">
                            <thead>
                                <tr>
                                    ...
                                    <th width="10%" class="text-center"> Rider Phone </th>
                                    <th width="8%" class="text-center"> Create Date </th>
                                     <th width="8%" class="text-center"> Complete Date </th>
                                    <th width="12%" class="text-center"> Amount to Be Collect </th>
                                    <th width="8%" class="text-center"> Run Parcel </th>
                                    <th width="8%" class="text-center"> Complete Parcel </th>
    ...
    window.onload = function(){
        ...
        function load_data(run_status = '', rider_id = '', from_date = '', to_date = ''){
            var table = $('#yajraDatatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url:'{!! route('branch.parcel.getDeliveryRiderRunList') !!}',
                    data:{
        ...
        $(document).on('click', '#printBtn', function(){
            ...
            $.ajax({
                type: 'GET',
                url: '{!! route('branch.parcel.printDeliveryRiderRunList') !!}',
                data: {
                    run_status  : run_status,
                    rider_id    : rider_id,
                    from_date   : from_date,
