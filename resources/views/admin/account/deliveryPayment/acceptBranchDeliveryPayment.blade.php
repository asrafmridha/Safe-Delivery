...
<div class="modal-body">
    <form role="form" action="{{ route('admin.account.confirmAcceptBranchDeliveryPayment', $parcelDeliveryPayment->id) }}" id="confirmAcceptBranchDeliveryPayment" method="POST" enctype="multipart/form-data" onsubmit="return createForm(this)">
        ...
        <input type="hidden" name="total_payment_received_parcel" id="total_payment_received_parcel" value="{{ $parcelDeliveryPayment->total_payment_parcel }}">
        <input type="hidden" name="total_payment_received_amount" id="total_payment_received_amount" value="{{ $parcelDeliveryPayment->total_payment_amount}}">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <fieldset>
...
<script>
    ...
    function createForm(object){
        ...
        var note                            = $("#note").val();
        // console.log(total_payment_received_amount);
