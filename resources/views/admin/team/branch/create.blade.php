                    ...
                    <div class="card-body">
                        <div class="offset-md-1 col-md-10 ">
                            <div class="card card-primary">
                                <form role="form" action="{{ route('admin.branch.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return createForm()">
                                  @csrf
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="name">Name</label>
                                            <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control" placeholder="Branch Name" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="address">Full Address</label>
                                            <input type="text" name="address" id="address" value="{{ old('address') }}" class="form-control" placeholder="Branch Address" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group parentBranch" style="display: none">
                                            <label for="parent_id"> Parent Branch Select </label>
  ...
  <script>
    ...
    window.onload = function(){
        ...
        $("#type").on("change", function () {
            var type   = $(this).val();
            if(type == "1"){
                $(".parentBranch").css("display", "none");
                $("#parent_id").val(0).change();
            }else{
                $(".parentBranch").css("display", "block");
            }
        });
