                        ...
                        <table id="yajraDatatable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th width="21%" class="text-center"> Service Area </th>
                                    <th width="13%" class="text-center"> Home Delivery </th>
                                    <th width="13%" class="text-center"> Lock Down Service </th>
    ...
    window.onload = function(){
        ...
        var table = $('#yajraDatatable').DataTable({
            ...
            columns: [
                ...
                { data: 'service_area.name', name: 'service_area.name',  orderable: false, class : "text-center"},
                { data: 'home_delivery', name: 'home_delivery', class : "text-center" },
                { data: 'lock_down_service', name: 'lock_down_service', class : "text-center" },
        ...
        $('#yajraDatatable').on('click', '.delete-btn', function(){
            ...
            var sttaus = confirm("Are you sure delete this district?");
